                            ...
                            <div class="block-content collapse in">
                             <?php
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><span class="label label-info">Lecturers</span>
                                ...
                                <div class="span3">
                                 <?php
                                    ...
                                    <div class="chart-bottom-heading"><span class="label label-info">Courses</span>
                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                              <?php
                                    ...
                                    ?>
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Lecturers</div>
                                    <div class="pull-right"><span class="badge badge-info"> <?php echo $percent;?></span>
